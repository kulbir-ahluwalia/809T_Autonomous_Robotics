...
with open('time_elapsed_data_Ass4_final.txt') as f:  #opening the text file
    for line in f:
        timeElapsedlist.append(float(line[0:14])) #extracting the first 14 digits of the float number for calculation
